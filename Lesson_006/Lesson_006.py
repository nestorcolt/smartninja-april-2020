...
class BasketballPlayer():
    ...
    def capitalize_full_name(self):
        capitalized_full_name = "{} {}".format(self.first_name, self.last_name).upper()
...
##############################################################################################
# Applying methodology in basket ball player class
"""
...
full_name = lebron.capitalize_full_name()
print(full_name)

full_name = kev_dur.capitalize_full_name()
print(full_name)
...
# Weight to pounds:
lebron_weight = lebron.weight_to_lbs()
kevin_weight = kev_dur.weight_to_lbs()

print("Weight in pounds: {} - Player = {}".format(lebron_weight, lebron.first_name))
print("Weight in pounds: {} - Player = {}".format(kevin_weight, kev_dur.first_name))
